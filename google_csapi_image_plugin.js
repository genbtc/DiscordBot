...
GoogleCustomSearchPlugin.prototype.respond = function (query, channel, bot) {
    this.google.customsearch('v1').cse.list({ cx:CX, auth: API_KEY, q: query, searchType: "image", enableImageSearch:"true", defaultToImageSearch:"true", disableWebSearch:"true", safe: "off", num:10}, function(err, resp) {
        if (err) {
